...
namespace HikvisionHelpers.SDK
{
    /// <summary>
    /// CHCNetSDK 的摘要说明。
    /// </summary>
    ...
    {
        private const string DllPathWindowsHCNetSDK = "SDK\\HCNetSDK.dll";
        public CHCNetSDK()
        {
            //
            // TODO: 在此处添加构造函数逻辑
        ...
        **************************************************/
        ...
        public struct NET_DVR_ALARMINFO_V40
        {
            ...
            public nint pAlarmData;   //报警可变部分内容
        }
        ...
        public struct NET_DVR_ALARMINFO_DEV
        {
            ...
            public nint pNO;  //dwNumber个WORD; 每个WORD表示一个通道号，或者磁盘号, 无效时为0
        }
        ...
        public struct NET_DVR_SINGLE_NFS
        {
            ...
            public void Init()
            {
                sNfsDirectory = new byte[PATHNAME_LEN];
            }
        }
        ...
        public struct NET_DVR_NFSCFG
        {
            ...
            public void Init()
            {
                struNfsDiskParam = new NET_DVR_SINGLE_NFS[MAX_NFS_DISK];
        ...
        public delegate void LOGINRESULTCALLBACK(int lUserID, int dwResult, nint lpDeviceInfo, nint pUser);
        ...
        public struct NET_DVR_CLIENTINFO
        {
            ...
            public nint hPlayWnd;//播放窗口的句柄,为NULL表示不播放图象
            public string sMultiCastIP;//多播组地址
        }
        ...
        public struct NET_VCA_RULE_ALARM
        {
            ...
            public nint pAppendInfo;     //指向附加信息NET_VCA_APPEND_INFO的指针，byAppendInfoUploadEnabled为1时或者byTimeDiffFlag为1时有效
            public nint pImage;//指向图片的指针
        }
        ...
        public struct NET_AIOP_VIDEO_HEAD
        {
            ...
            public nint pBufferAIOPData;  //AIOPDdata数据
            public nint pBufferPicture;//对应分析图片数据
        ...
        public struct NET_AIOP_POLLING_SNAP_HEAD
        {
            ...
            public byte[] szMPID;       //检测模型包ID，用于匹配AIOP的检测数据解析；
            public nint pBufferAIOPData;//AIOPDdata数据
            public nint pBufferPicture;//分析图片数据
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 184, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
        }
        ...
        public struct NET_DVR_PIC
        {
            ...
            public nint byPicDataBuff;    //图片数据缓冲区
        ...
        public struct NET_DVR_FACEDETECT_ALARM
        {
            ...
            public byte[] byRes;              // 保留字节
            public nint pFaceImage; //指向人脸图指针
            public nint pImage;   						//指向图片的指针
        }
        ...
        public struct NET_DVR_AID_ALARM_V41
        {
            ...
            public nint pXmlBuf;// XML报警信息指针,其XML对应到EventNotificationAlert XML Block
        ...
        public struct NET_DVR_PLATE_INFO
        {
            ...
            public uint dwXmlLen;                        //XML报警信息长度
            public nint pXmlBuf;                      // XML报警信息指针,报警类型为 COMM_ITS_PLATE_RESUL时有效，其XML对应到EventNotificationAlert XML Block
        ...
        public struct NET_DVR_PLATE_RESULT
        {
            ...
            public nint pBuffer3;
            public nint pBuffer4;
            public nint pBuffer5;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes3;
            public NET_DVR_PLATE_INFO struPlateInfo;
            public NET_DVR_VEHICLE_INFO struVehicleInfo;
            public nint pBuffer1;
            public nint pBuffer2;
        ...
        public struct NET_DVR_IPC_PROTO_LIST_V41
        {
            public uint dwSize;
            public uint dwProtoNum;  //有效的ipc协议数目
            public nint pBuffer;    //协议列表缓冲区, dwProtoNum 个NET_DVR_PROTO_TYPE结构
        ...
        public struct NET_DVR_AUTH_INFO
        {
            ...
            public nint pImage; //图片指针（当认证方式byAuthType为人脸时有效）
        ...
        {
            public uint dwSize;//结构体大小
            public nint lpRequestUrl;//请求信令，字符串格式
            public uint dwRequestUrlLen;
            public nint lpInBuffer;//输入参数缓冲区，XML格式
        ...
        {
            public uint dwSize;//结构体大小
            public nint lpOutBuffer;//输出参数缓冲区，XML格式
            public uint dwOutBufferSize;
            public uint dwReturnedXMLSize;//实际输出的XML内容大小
            public nint lpStatusBuffer;//返回的状态参数(XML格式：ResponseStatus)，获取命令成功时不会赋值，如果不需要，可以置NULL
        ...
        {
            public nint lpCondBuffer;
            public uint dwCondSize;
            public nint lpInBuffer;
            public uint dwInSize;
            public nint lpOutBuffer;
            public uint dwOutSize;
            public nint lpStatusBuffer;
            public uint dwStatusSize;
            public nint lpXmlBuffer;
        ...
        public struct NET_VCA_FACESNAP_RESULT
        {
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes1;     // 保留字节
            public nint pUIDBuffer;  //标识指针
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 7, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes2;              // 保留字节
            public byte byBrokenNetHttp;     //断网续传标志位，0-不是重传数据，1-重传数据
            public nint pBuffer1;//指向人脸子图的图片数据
            public nint pBuffer2;//背景图的图片数据（保留，通过查找背景图接口可以获取背景图）
        }
        ...
        public struct NET_DVR_FACE_DETECTION
        {
            ...
            public byte[] byRes;//保留
            public nint pBackgroundPicpBuffer;//背景图的图片数据
        }
        ...
        public struct NET_VCA_PICMODEL_RESULT
        {
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes; //保留
            public nint pImage;  //人脸图片数据指针
            public nint pModel;  //模型数据指针
        }
        ...
        public struct NET_VCA_HUMAN_ATTRIBUTE
        {
            ...
            public nint pPersonInfoExtend;  //人员标签信息扩展信息
        ...
        public struct NET_VCA_BLOCKLIST_INFO
        {
            ...
            public nint pFDDescriptionBuffer;//人脸库描述数据指针
            public uint dwFCAdditionInfoLen;//抓拍库附加信息长度
            public nint pFCAdditionInfoBuffer;//抓拍库附加信息数据指针（FCAdditionInfo中包含相机PTZ坐标）
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes2;//保留
        }
        ...
        public struct NET_VCA_FACESNAP_INFO_ALARM
        {
            ...
            public nint pUIDBuffer;  //标识指针
            public float fStayDuration;  //停留画面中时间(单位: 秒)
            public nint pBuffer1;  //抓拍人脸子图的图片数据
        }
        ...
        public struct NET_VCA_BLOCKLIST_INFO_ALARM
        {
            ...
            public nint pFDID;  //人脸库Id指针
            public uint dwPIDLen;// 人脸库图片ID长度
            public nint pPID;  //人脸库图片ID指针
            public ushort wThresholdValue; //人脸库阈值[0,100]
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;//保留
            public nint pBuffer1;//指向图片的指针
        }
        ...
        public struct NET_VCA_FACEMATCH_PICTURE
        {
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;              //保留字节
            public nint pSnapFace;  //抓拍人脸子图的图片数据
            public nint pBlockListFace;  //比对的非准入名单人脸子图数据
        }
        ...
        public struct NET_DVR_MATRIX_SCENECFG
        {
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 12, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes2;
            public nint pBigScreenBuffer;//大屏配置缓冲区, byBigScreenNums×sizeof(NET_DVR_BIGSCREENCFG_SCENE)
            public nint pDecChanBuffer;//解码通道配置缓冲区, wDecChanNums×sizeof(NET_DVR_DECODECHANCFG_SCENE)
            public nint pDispChanBuffer;//显示通道配置缓冲区, wDispChanNums×sizeof(NET_DVR_SCENEDISPCFG)
            public void Init()
            {
        ...
        public struct NET_DVR_WINLIST
        {
            ...
            public nint pBuffer;	//窗口信息缓冲区，最大为224*sizeof(NET_DVR_WINCFG)
        ...
        public struct NET_DVR_PLAN_LIST
        {
            ...
            public nint pBuffer;			//指向dwInputSignalNums个NET_DVR_PLAN_CFG结构大小的缓冲区
        ...
        public struct NET_DVR_INPUT_SIGNAL_LIST
        {
            ...
            public nint pBuffer;			//指向dwInputSignalNums个NET_DVR_INPUTSTREAMCFG结构大小的缓冲区
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes1;
        ...
        public struct NET_ITS_PLATE_RESULT
        {
            ...
            public nint pIllegalInfoBuf;    //违法代码字符信息结构体指针；指向NET_ITS_ILLEGAL_INFO
        ...
        public struct NET_DVR_FIREDETECTION_ALARM
        {
            ...
            */
            ...
            public nint pVisiblePicBuf;    //可见光图片数据指针
            // pSmokeBuf参数当byAlarmSubType报警子类型为1（烟雾检测报警）、2（烟火报警）时生效。
            public nint pSmokeBuf;    //烟雾检测报警数据指针，指向一个NET_DVR_SMOKEDETECTION_ALARM结构体
            public ushort wDevInfoIvmsChannelEx;     //与NET_VCA_DEV_INFO里的byIvmsChannel含义相同，能表示更大的值。老客户端用byIvmsChannel能继续兼容，但是最大到255。新客户端版本请使用wDevInfoIvmsChannelEx。
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 58, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
        }
        ...
        public struct NET_DVR_ID_CARD_INFO_ALARM
        {
            ...
            public nint pFingerPrintData;
            public uint dwCapturePicDataLen;                   // 抓拍图片数据大小，不为0是表示后面带数据
            public nint pCapturePicData;
        ...
        **********************************************************/
        [DllImport(DllPathWindowsHCNetSDK)]
        ...
        **********************************************************/
        ...
        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern bool NET_DVR_SetDVRMessage(uint nMessage, nint hWnd);
        ...
        Return:
        **********************************************************/
        public delegate void EXCEPYIONCALLBACK(uint dwType, int lUserID, int lHandle, nint pUser);

        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern bool NET_DVR_SetExceptionCallBack_V30(uint nMessage, nint hWnd, EXCEPYIONCALLBACK fExceptionCallBack, nint pUser);
        ...
        **********************************************************/
        ...
        Return:
        **********************************************************/
        public delegate int MESSAGECALLBACK(int lCommand, nint sDVRIP, nint pBuf, uint dwBufLen, uint dwUser);
        ...
        **********************************************************/
        ...
        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern bool NET_DVR_SetDVRMessageCallBack_V30(MSGCallBack fMessageCallBack, nint pUser);

        public delegate bool MSGCallBack_V31(int lCommand, ref NET_DVR_ALARMER pAlarmer, nint pAlarmInfo, uint dwBufLen, nint pUser);

        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern bool NET_DVR_SetDVRMessageCallBack_V31(MSGCallBack_V31 fMessageCallBack, nint pUser);

        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern bool NET_DVR_SetSDKLocalCfg(int enumType, nint lpInBuff);

        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern bool NET_DVR_GetSDKLocalCfg(int enumType, nint lpOutBuff);
        ...
        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern int NET_DVR_StartListen_V30(string sLocalIP, ushort wLocalPort, MSGCallBack DataCallback, nint pUserData);
        ...
        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern nint NET_DVR_GetErrorMsg(ref int pErrorNo);

        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern bool NET_DVR_SetShowMode(uint dwShowType, uint colorKey);

        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern bool NET_DVR_GetDVRIPByResolveSvr(string sServerIP, ushort wServerPort, string sDVRName, ushort wDVRNameLen, string sDVRSerialNumber, ushort wDVRSerialLen, nint pGetIP);
		...
		Return:	void
		**********************************************************/
        public delegate void REALDATACALLBACK(int lRealHandle, uint dwDataType, nint pBuffer, uint dwBufSize, nint pUser);
        [DllImport(DllPathWindowsHCNetSDK)]
        ...
        **********************************************************/
        public static extern int NET_DVR_RealPlay_V30(int iUserID, ref NET_DVR_CLIENTINFO lpClientInfo, REALDATACALLBACK fRealDataCallBack_V30, nint pUser, uint bBlocked);
        ...
        **********************************************************/
        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern int NET_DVR_RealPlay_V40(int iUserID, ref NET_DVR_PREVIEWINFO lpPreviewInfo, REALDATACALLBACK fRealDataCallBack_V30, nint pUser);
		...
		**********************************************************/
        ...
        Return:
        **********************************************************/
        public delegate void DRAWFUN(int lRealHandle, nint hDc, uint dwUser);
        ...
        Return:
        **********************************************************/
        public delegate void SETREALDATACALLBACK(int lRealHandle, uint dwDataType, nint pBuffer, uint dwBufSize, uint dwUser);
        ...
        **********************************************************/
        ...
        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern int NET_DVR_PlayBackByName(int lUserID, string sPlayBackFileName, nint hWnd);

        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern int NET_DVR_PlayBackByTime(int lUserID, int lChannel, ref NET_DVR_TIME lpStartTime, ref NET_DVR_TIME lpStopTime, nint hWnd);
        ...
        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern bool NET_DVR_PlayBackControl_V40(int lPlayHandle, uint dwControlCode, nint lpInBuffer, uint dwInValue, nint lpOutBuffer, ref uint LPOutValue);
        ...
        Return:
        **********************************************************/
        public delegate void PLAYDATACALLBACK(int lPlayHandle, uint dwDataType, nint pBuffer, uint dwBufSize, uint dwUser);
        ...
        **********************************************************/
        ...
        Return:
        **********************************************************/
        public delegate void VOICEDATACALLBACKV30(int lVoiceComHandle, nint pRecvDataBuffer, uint dwBufSize, byte byAudioFlag, nint pUser);

        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern int NET_DVR_StartVoiceCom_V30(int lUserID, uint dwVoiceChan, bool bNeedCBNoEncData, VOICEDATACALLBACKV30 fVoiceDataCallBack, nint pUser);
        ...
        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern int NET_DVR_StartVoiceCom_MR_V30(int lUserID, uint dwVoiceChan, VOICEDATACALLBACKV30 fVoiceDataCallBack, nint pUser);
        ...
        Return:
        **********************************************************/
        public delegate void VOICEAUDIOSTART(string pRecvDataBuffer, uint dwBufSize, nint pUser);

        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern bool NET_DVR_ClientAudioStart_V30(VOICEAUDIOSTART fVoiceAudioStart, nint pUser);
        ...
        **********************************************************/
        ...
        //解码 nBitrate = 16000
        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern nint NET_DVR_InitG722Decoder(int nBitrate);

        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern void NET_DVR_ReleaseG722Decoder(nint pDecHandle);

        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern bool NET_DVR_DecodeG722Frame(nint pDecHandle, ref byte pInBuffer, ref byte pOutBuffer);

        //编码
        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern nint NET_DVR_InitG722Encoder();

        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern bool NET_DVR_EncodeG722Frame(nint pEncodeHandle, ref byte pInBuffer, ref byte pOutBuffer);

        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern void NET_DVR_ReleaseG722Encoder(nint pEncodeHandle);
        ...
        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern bool NET_DVR_InitDDraw_Card(nint hParent, uint colorKey);
        ...
        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern nint NET_DVR_GetChanHandle_Card(int lRealHandle);
        ...
        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern bool NET_DVR_MatrixSendData(int lPassiveHandle, nint pSendBuf, uint dwBufSize);

        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern bool NET_DVR_MatrixStopPassiveDecode(int lPassiveHandle);

        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern bool NET_DVR_UploadLogo(int lUserID, uint dwDispChanNum, ref NET_DVR_DISP_LOGOCFG lpDispLogoCfg, nint sLogoBuffer);
        ...
        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern bool NET_DVR_GetDVRWorkState_V30(int lUserID, nint pWorkState);
        ...
        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern bool NET_DVR_GetAlarmOut_V30(int lUserID, nint lpAlarmOutState);
        ...
        **********************************************************/
        ...
        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern bool NET_DVR_GetDeviceConfig(int lUserID, uint dwCommand, uint dwCount, nint lpInBuffer, uint dwInBufferSize, nint lpStatusList, nint lpOutBuffer, uint dwOutBufferSize);

        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern bool NET_DVR_SetDeviceConfig(int lUserID, uint dwCommand, uint dwCount, nint lpInBuffer, uint dwInBufferSize, nint lpStatusList, nint lpInParamBuffer, uint dwInParamBufferSize);
        ...
        [DllImport(DllPathWindowsHCNetSDK)]
        public static extern bool NET_DVR_SendRemoteConfig(int lHandle, int dwDataType, nint pSendBuf, int dwBufSize);
		...
		**********************************************************/
        ...
        public static extern int PostMessage(nint hWnd, int Msg, int wParam, int lParam);
        #endregion
        ...
        */
        ...
        {
            public nint sessionHandle;                                    //[in]VOD客户端句柄
        ...
        // 异常回调函数
        public delegate void ErrorCallback(nint hSession, uint dwUser, int lErrorType);
        //帧数据回调函数
        public delegate void VodStreamFrameData(nint hStream, uint dwUser, int lFrameType, nint pBuffer, uint dwSize);

        //模块初始化
        [DllImport("PdCssVodClient.dll")]
        public static extern bool VODServerConnect(string strServerIp, uint uiServerPort, ref nint hSession, ref CONNPARAM struConn, nint hWnd);

        //模块销毁
        [DllImport("PdCssVodClient.dll")]
        public static extern bool VODServerDisconnect(nint hSession);

        [DllImport("PdCssVodClient.dll")]
        public static extern bool VODStreamSearch(nint pSearchParam, ref nint pSecList);

        [DllImport("PdCssVodClient.dll")]
        public static extern bool VODDeleteSectionList(nint pSecList);

        // 根据ID、时间段打开流获取流句柄
        [DllImport("PdCssVodClient.dll")]
        public static extern bool VODOpenStream(nint pOpenParam, ref nint phStream);

        [DllImport("PdCssVodClient.dll")]
        public static extern bool VODCloseStream(nint hStream);

        //根据ID、时间段打开批量下载
        [DllImport("PdCssVodClient.dll")]
        public static extern bool VODOpenDownloadStream(ref VODOPENPARAM struVodParam, ref nint phStream);

        [DllImport("PdCssVodClient.dll")]
        public static extern bool VODCloseDownloadStream(nint hStream);

        // 开始流解析，发送数据帧
        [DllImport("PdCssVodClient.dll")]
        public static extern bool VODStartStreamData(nint phStream);
        [DllImport("PdCssVodClient.dll")]
        public static extern bool VODPauseStreamData(nint hStream, bool bPause);
        [DllImport("PdCssVodClient.dll")]
        public static extern bool VODStopStreamData(nint hStream);

        // 根据时间定位
        [DllImport("PdCssVodClient.dll")]
        public static extern bool VODSeekStreamData(nint hStream, nint pStartTime);


        // 根据时间定位
        [DllImport("PdCssVodClient.dll")]
        public static extern bool VODSetStreamSpeed(nint hStream, int iSpeed);

        // 根据时间定位
        [DllImport("PdCssVodClient.dll")]
        public static extern bool VODGetStreamCurrentTime(nint hStream, ref BLOCKTIME pCurrentTime);
        ...
        ******************************************************************************/
        [DllImport("AnalyzeData.dll")]
        public static extern bool AnalyzeDataInputData(int iHandle, nint pBuffer, uint uiSize); //byte []
        ...
        ******************************************************************************/
        [DllImport("AnalyzeData.dll")]
        public static extern bool AnalyzeDataGetTail(int iHandle, ref nint pBuffer, ref uint uiSize);
        ...
        public delegate int CALLBACKFUN_MESSAGE(int iMessageType, nint pBuf, int iBufLen);
        ...
        [DllImport("RecordDLL.dll")]
        public static extern int OpenChannelRecord(string strCameraid, nint pHead, uint dwHeadLength);

        [DllImport("RecordDLL.dll")]
        public static extern bool CloseChannelRecord(int iRecordHandle);

        [DllImport("RecordDLL.dll")]
        public static extern int GetData(int iHandle, int iDataType, nint pBuf, uint uiSize);
